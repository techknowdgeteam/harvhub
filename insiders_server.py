...
OUTPUT_FILE_PATH = r"C:\xampp\htdocs\chronedge\synarypt\usersdictionary.json"
MT5_TEMPLATE_SOURCE_DIR = r"C:\xampp\htdocs\chronedge\mt5\MetaTrader 5"
BROKERS_OUTPUT_FILE_PATH = r"C:\xampp\htdocs\chronedge\synarypt\brokersdictionary.json"
...
def cleanup_stale_records_in_updatedusers():
    ...
    """
    USERSDICTIONARY_JSON = r"C:\xampp\htdocs\chronedge\synarypt\usersdictionary.json"
    UPDATEDUSERS_JSON    = r"C:\xampp\htdocs\chronedge\synarypt\updatedusersdictionary.json"
...
def update_table_fromupdatedusers():
    ...
    """
    USERS_JSON_PATH = r"C:\xampp\htdocs\chronedge\synarypt\updatedusersdictionary.json"
...
def fetch_insiders_server_rows():
    ...
    try:
        ...
        for row in rows:
            ...
            # Paths
            base_folder = rf"C:\xampp\htdocs\chronedge\synarypt\chart\{broker_clean} {user_id}"
            terminal_folder = rf"C:\xampp\htdocs\chronedge\synarypt\mt5\MetaTrader 5 {broker_clean} {user_id}"
...
def requirements():
    REQUIREMENTS_FILE = r"C:\xampp\htdocs\chronedge\synarypt\requirements.json"
...
def move_verifiedusers_to_brokersdictionary(): 
    ...
    def validdetails_verified():
        ...
        """
        UPDATED_USERS_OUTPUT_FILE_PATH = r"C:\xampp\htdocs\chronedge\synarypt\updatedusersdictionary.json"
    ...
    def update_application_status_in_database():
        USERS_JSON_PATH = r"C:\xampp\htdocs\chronedge\synarypt\usersdictionary.json"
        insiders_server_TABLE = "insiders_server"
